          ...
          <div className="faculty-card">
            ...
            <div className="faculty-info">
              ...
              <p className="faculty-bio">
                Department of Energy Science and Engineering, IIT Delhi. Department is leading research in sustainable energy systems and mentoring the next generation of energy professionals.
              </p>
            </div>
          </div>
        </div>
